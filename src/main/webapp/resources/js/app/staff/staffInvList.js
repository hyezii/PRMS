...
document.addEventListener("DOMContentLoaded", () => {
	...
	function Bform() {
		...
		fetch(`${contextPath}/main/staff/staffEmerFranInvList.do?${data}&&what=${emerReqstId}`,{
			headers: {
					...
					listBody.innerHTML += `
						<div class="col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-sm-6 pb-4" data-type="desserts">
							<a href="#" class="pos-product">
								...
								<div class="info">
									<div class="title">${data.fiList[i].franprodNm}</div>
		...
		Swal.fire({
		   ...
		   // 만약 Promise리턴을 받으면,
		   	if(result.isConfirmed) { // 만약 모달창에서 confirm 버튼을 눌렀다면
				...
				// 비동기로 인서트 요청
				let url = `${contextPath}/main/staff/staffInsertEmer.do`;
				let method = "POST";
				let headers = {
