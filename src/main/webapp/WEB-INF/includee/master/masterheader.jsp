...
<!-- BEGIN #header -->
			...
			<!-- BEGIN brand -->
			<div class="brand">
				<a href="${cPath}/main/master/masterpage.do#masterpage" class="brand-logo">
					본사총괄관리자
				</a>
			</div>
			<!-- END brand -->
			...
			<div class="menu">
				<div class="menu-item dropdown dropdown-mobile-full">
					...
					<div class="dropdown-menu fade dropdown-menu-end w-100px text-center p-0 mt-1 overflow-hidden">
...
<!-- 							</div> -->
							<div class="col-12">
								<div class="h-100 p-1">
									<a href="${pageContext.request.contextPath }/main/master/calendar" class="dropdown-item p-2 rounded-2">
										<div class="position-relative pt-1">
...
<!-- 						</div> -->
				...
				<div class="menu-item dropdown dropdown-mobile-full">
					...
					<div class="dropdown-menu dropdown-menu-end mt-1 w-350px pt-1">
						<h6 class="dropdown-header mb-1">Notifications<span id="alermCount"></span></h6>
				...
				<div class="menu-item dropdown dropdown-mobile-full">
					<a href="#" data-bs-toggle="dropdown" data-bs-display="static" class="menu-link">
						<div class="menu-img online">
							<span class="menu-img-bg" style="background-image: url(${pageContext.request.contextPath}/resources/images/company.png)"></span>
						</div>
						<div class="menu-text d d-none">Petconomy@account.com</div>
					</a>
