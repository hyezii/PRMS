...
<!-- BEGIN #header -->
			...
			<!-- BEGIN brand -->
			<div class="brand">
				<a href="${pageContext.request.contextPath }/employeepage.do" class="brand-logo">
					본사직원
				</a>
			</div>
			<!-- END brand -->
				...
				<div class="menu-item dropdown dropdown-mobile-full">
					...
					<div class="dropdown-menu dropdown-menu-end me-lg-3 mt-1 w-200px">
						...
						<form action="${cPath }/main/logout">
							<button type="submit" class="dropdown-item d-flex align-items-center"><i class="fa fa-arrow-right-from-bracket fa-fw fa-lg me-3"></i>Logout</button>
						</form>
					</div>
				</div>
			</div>
