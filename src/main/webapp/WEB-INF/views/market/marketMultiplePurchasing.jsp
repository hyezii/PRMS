                    ...
                    <div class="row ms_breadcrumb_inner">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <ul class="ms-breadcrumb-list">
                                ...
                                <li class="ms-breadcrumb-item active">장바구니 결제</li>
                            </ul>
                        ...
                        <div class="ms-checkout-inner">
							<div class="ms-checkout-wrap m-b-30">
							    ...
							    <div class="ms-checkout-block ms-check-login">
							        <h3 class="ms-checkout-title d-inline">
							            <span>
							                <h6 class="ms-checkout-title d-inline me-3">${member.memNm }</h6>
							                <span class="badge bg-light text-secondary me-3" id="addInfo">기본배송지</span>
							            </span>
							            <span>
							                <button type="button" class="ms-btn-1 btn btn-sm" id="changeAddressBtn">배송지 변경</button>
							            </span>
							        </h3>
							        <br><br>
							        <div class="ms-check-login-form">
							            <div class="row">
							                <div class="col-md-6">
							                    ...
							                    <div class="mb-3">
							                        <button type="button" class="ms-btn-1 btn btn-sm" onclick="sample6_execDaumPostcode()">우편번호 찾기</button>
							                    </div>
							                </div>
							                <div class="col-md-6">
							                    <div class="mb-3">
...
<!--                                         <div class="ms-check-subtitle mb-3">구매 적립 / 선할인</div> -->
<!--                                         <span class="ms-bill-option"> -->
<!--                                             <span> -->
<!--                                                 <input type="radio" id="after-discount" name="discount-radio-group" checked> -->
<%--                                                 <label for="after-discount">구매 적립<span class="text-primary">(<span id="pre-discount-price" style="margin:0px;">${payMl}</span>원 적립)</span></label> --%>
<!--                                             </span> -->
<!--                                             <span> -->
...
<%-- 	                                        	<input type="text" class="form-control" id="memMl" name="memMl" placeholder="${member.memMl > 0 ? hasMl : hasNoMl}"> <span class="text-danger" id="canMl">${member.memMl > 0 ? member.memMlComma : ""}</span><span class="text-danger">${member.memMl > 0 ? "점 사용가능" : "보유하신 적립금이 없습니다."}</span> --%>
<!-- 	                                        </div> -->
<!-- 										</div> -->
...
<!--                             </div> -->
							    ...
							    <div class="ms-checkout-block ms-check-bill">
							        ...
							        <div class="ms-bl-block-content">
							            <div class="row">
							                <div class="col-md-6">
							                    <div class="mb-3">
							                        <label for="after-discount" class="ms-check-subtitle">구매 적립 / 선할인</label>
							                        <div class="mt-3">
							                            <div class="form-check">
							                                <input class="form-check-input" type="radio" name="discount-radio-group" id="after-discount" checked>
							                                <label class="form-check-label" for="after-discount">
							                                    구매 적립<span class="text-primary">(<span id="pre-discount-price">${payMl}</span>원 적립)</span>
							                                </label>
							                            </div>
							                            <div class="form-check">
							                                <input class="form-check-input" type="radio" name="discount-radio-group" id="pre-discount">
							                                <label class="form-check-label" for="pre-discount">
							                                    적립금 선할인
							                                </label>
							                            </div>
							                        </div>
							                     ...
							                     <div class="mb-3">
													<div class="ms-check-subtitle mb-3">쿠폰사용</div>
							                        <div class="row g-3">
							                            <div class="col-auto">
															<select name="my-coupon-list" id="my-coupon-list" class="form-control">
																<option value="">쿠폰선택</option>
							                     ...
							                     <div class="col-md-6">
							                     <div class="mb-3">
							                     <div class="ms-check-subtitle mb-3">보유 적립금 사용</div>
							                        <div class="row g-3">
							                            <div class="col-auto">
								                           	<c:set value="적립금을 입력하세요."  var="hasMl" />
								                           	<c:set value="보유하신 적립금이 없습니다."  var="hasNoMl" />
								                            <input type="text" class="form-control" id="memMl" name="memMl" placeholder="${member.memMl > 0 ? hasMl : hasNoMl}">

								                            <div class="d-flex justify-content-between mt-3">
								                            	<div>
										                        	<span class="text-danger" id="canMl">${member.memMl > 0 ? member.memMlComma : ""}</span>
										                        	<span class="text-danger">${member.memMl > 0 ? "점 사용가능" : "보유하신 적립금이 없습니다."}</span>
									                        	</div>
									                        	<button class="ms-btn-2" type="button" id="mlApplyBtn">적용</button>
									                        </div>
							                           	</div>
													</div>
							                     </div>
                            ...
                            <div class="ms-sb-block-content">
                                <div class="ms-checkout-summary">
                                    <div>
                                        ...
                                        <span class="text-right"><span id="orderPrice">${total }</span>원</span>
                                    </div>
                                    <div>
                                    ...
                                    <div class="ms-checkout-summary-total">
                                        ...
                                        <span class="text-right"><span id="totalPrice">${total }</span>원</span>
                                    </div>
                                </div>
                                <c:forEach items="${cartList }" var="cart">
                                	<input type="hidden" class="prodId pay" value="${cart.prodId }">
	                                    ...
	                                    <div class="col-sm-12 mb-6">
	                                        <div class="ms-product-inner">
	                                            ...
	                                            <div class="ms-pro-content">
	                                                <h5 class="ms-pro-title"><a href="${cPath }/market/prodDetail/${cart.prodId}" class="prodNm">${cart.prod.prodSleNm }</a></h5>
	                                                <span>수량 : <span class="cdQy">${cart.cdQy }</span></span>
	                                                <span class="ms-price mt-2">
	                                                    <span class="new-price prodQyPrice">${cart.prod.prodSlePcComma }</span>
	                                                    <span class="new-price">원</span>
	                                                </span>
	                                            </div>
	                                        </div>
	                                    </div>
                                ...
                                <div class="ms-checkout-pay">
                                        <div class="ms-pay-option">
                                            <div>
                                                ...
                                                <label for="kakaopay" class="mb-3">카카오페이<img src="${cPath }/resources/images/카카오페이_CI_combination_with_BG.png" style="width: 35px; margin-left: 5px;"></label>
                                            </div>
                                            <div>
                                                <input type="radio" id="kcp" name="radio-group" data-pay-method="card">
                                                <label for="kcp">카드결제<i class="bi bi-credit-card-fill" style="margin-left:5px;"></i></label>
                                            </div>
                                        </div>
                                </div>
                            </div>
	...
	<script src="${cPath }/resources/js/app/market/payment/marketMultiplePurchasing.js"></script>
