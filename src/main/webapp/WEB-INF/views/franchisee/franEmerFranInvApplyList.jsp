...
<%@ taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
		...
		<!-- END mobile-sidebar-backdrop -->
			...
			<div class="d-flex align-items-center mb-3">
				<div>
					<ul class="breadcrumb">
						...
						<li class="breadcrumb-item active">긴급재고신청내역</li>
					</ul>
					<h1 class="page-header mb-0">긴급재고신청내역</h1>
				</div>
			</div>
			...
			<div class="card">
				<div class="tab-content p-4">
							...
							<table class="table table-hover text-nowrap text-center">
								<thead>
									<tr>
										...
										<th class="border-top-0 pt-0 pb-2">신청한 가맹점</th>
										...
										<th class="border-top-0 pt-0 pb-2">신청 총금액</th>
											...
											<tr>
												...
												<c:choose>
													<c:when test="${emer.emerPartn eq 'P'}">
														<td class="py-1 align-middle">
															<form class="updateForm" action="${cPath }/main/franchisee/franEmerFranApplyUpdate.do">
																<input type="hidden" name="emerNo" value="${emer.emerNo }"/>
																<input type="hidden" name="emerPartn" value="C"/>
																<input type="hidden" name="searchWord" value="${simpleCondition.searchWord}"/>
																<input type="hidden" name="page" value="${page}"/>
															</form>
															<input type="button" class="btn btn-primary btn-sm emerCancel" value="발주취소" />
														</td>
													</c:when>
													<c:otherwise>
						...
						<!-- END table -->
						<form:form id="searchform" method="get" action="${cPath }/main/franchisee/franEmerFranInvApplyList.do">
	...
	<!-- BEGIN btn-scroll-top -->
		...
		<%-- update.js--%>
		<script src="${cPath }/resources/js/app/franchise/franEmerInvUpdate.js"></script>
