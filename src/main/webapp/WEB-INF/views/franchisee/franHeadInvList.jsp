...
.truncate {
		...
		style="width: 103%; background-color: #f8f9fa; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.2);">
			<div id="myFranchiseId" class="border rounded" data-my-franchise-id="${franchiseId }"
				style="display: flex; margin-top: 20px; margin-bottom: 20px; padding: 10px; width: 100%;
				box-shadow: 0px 2px 4px rgba(0, 0, 0, 0.1)">
				<div class="input-group flex-nowrap mb-6 position-relative">
					<div id="BsearchUI" style="width: 100%">
						<input placeholder="상품명을 입력하세요" type="text" id="searchWord" name="searchWord" class="form-control px-35px rounded Benterkey" />
			...
			<div class="pos-content">
				...
				<ul class="pagination mb-3 justify-content-end flex-wrap Bpaging-area">
				</ul>
							...
							<div class="d-flex">
								<button type="button" id="emerSubmit" class="btn btn-theme flex-fill d-flex align-items-center justify-content-center">
									<span>
										...
										<span class="small fw-semibold">발주신청</span>
									</span>
								</button>
							</div>
						</div>
	...
	<%-- invList.js --%>
	<script src="${cPath }/resources/js/app/franchise/franHeadInvList.js"></script>
