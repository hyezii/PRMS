        ...
        <div class="container">
            ...
            <div class="row p-t-15" id="section-qna">
                <div class="col-md-6" id="section-width">
                    <form method="post" action="/prms/market/member/${center.ctrBbsNo}/updateCenter" enctype="multipart/form-data" modelAttribute="centerList">
                        <div class="form-group">
                         <h6>제목</h6>
                            <input type="text" class="form-control ctrBbsNm-style" name="ctrBbsNm" id="ctrBbsNm" value="${center.ctrBbsNm }">
                        </div>
                         <div class="form-group">
                         <h6>질문유형</h6>
                           <select class="form-control ctrBbsType-style" name="ctrBbsSn">
	                           	<option value="">${center.ctrBbsSn }</option>
                        ...
                        <div class="form-group">
                         <textarea class="form-control" name="ctrBbsCn" id="ctrBbsCn" rows="3" placeholder="문의할내용을 입력해주세요">${center.ctrBbsCn }</textarea>
                        </div>
	                        <div id="noticeMarketBtn">
	                            <button type="submit" class="btn ms-btn-2" id="updateBtn">수정하기</button>
								<button type="button" class="btn ms-btn-2" onclick = "location.href ='${cPath}/market/member/centerMarketList'">목록보기</button>
	                        </div>
                    </form>
                </div>
            </div>
