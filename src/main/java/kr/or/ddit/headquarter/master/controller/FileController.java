...
/**
 * 쌤이주신 파일 다운로드 업로드 관련 Util모음 참고용
 * 사용안하고 같은 폴더의 DownloadAndDeleteController 이용
 * @author PC-12
 *
 */
@Slf4j
...
//	String uploadFolderDirect;
	...
	// 요청URI :
	// /download?fileName=76890bda-122c-4b7b-8af3-1eedbe99c5ce_ksh.jpg
	@ResponseBody
	@RequestMapping(value = "/download", produces = MediaType.APPLICATION_OCTET_STREAM_VALUE)
	public ResponseEntity<Resource> downloadFile(String fileName, HttpSession session) {
		// ?fileName=76890bda-122c-4b7b-8af3-1eedbe99c5ce_ksh.jpg
		log.info("download file : " + fileName);

		//String realPath = session.getServletContext().getRealPath("/resources/upload");
		
		String realPath = "D:\\saveFiles\\";
		
		// core.io
		//D:\\saveFiles\\76890bda-122c-4b7b-8af3-1eedbe99c5ce_ksh.jpg
	...
	public Map<String, Object> image(MultipartHttpServletRequest request) throws Exception {
		...
		String savePath = "D:\\saveFiles" + "\\" + newFileName;
