...
public class ArticlePage {
	...
	// 게시글 데이터
	private List<PartprodDefaultVO> content;

	// 생성자
	// size : 한 화면에 보여질 행의 수
	public ArticlePage(int total, int currentPage, int size, int pagingCount, List<PartprodDefaultVO> content) {
		this.total = total;
	...
	// 데이터 VO List 리턴
	public List<PartprodDefaultVO> getContent() {
		return this.content;
	}
